...
public class RecyclerViewAdapter_Rukun_Sholat extends RecyclerView.Adapter<RecyclerViewAdapter_Rukun_Sholat.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Rukun_Sholat.User> values;
    Context context1;

    public RecyclerViewAdapter_Rukun_Sholat(Context context, List<Activity_Rukun_Sholat.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Rukun_Sholat.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_syarat_wudhu, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Rukun_Sholat.RecyclerViewHolder holder, final int position) {
