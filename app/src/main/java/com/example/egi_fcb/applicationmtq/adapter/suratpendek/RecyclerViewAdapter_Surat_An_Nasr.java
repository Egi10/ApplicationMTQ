...
public class RecyclerViewAdapter_Surat_An_Nasr extends RecyclerView.Adapter<RecyclerViewAdapter_Surat_An_Nasr.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Surat_An_Nasr.User> values;
    Context context1;

    public RecyclerViewAdapter_Surat_An_Nasr(Context context, List<Activity_Surat_An_Nasr.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Surat_An_Nasr.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_ayat, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Surat_An_Nasr.RecyclerViewHolder holder, final int position) {
