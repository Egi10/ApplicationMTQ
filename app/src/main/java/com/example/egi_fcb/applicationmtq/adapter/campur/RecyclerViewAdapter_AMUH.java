...
import com.example.egi_fcb.applicationmtq.activity.hijaiyah.Activity_Hijaiyah_Fathah;
import com.example.egi_fcb.applicationmtq.activity.hijaiyah.Activity_Hijaiyah_Kasrah;
...
public class RecyclerViewAdapter_AMUH extends RecyclerView.Adapter<RecyclerViewAdapter_AMUH.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Menu_Utama_Harakat.User> values;
    Context context1;

    public RecyclerViewAdapter_AMUH(Context context, List<Activity_Menu_Utama_Harakat.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_AMUH.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_menu_utama_harakat, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_AMUH.RecyclerViewHolder holder, final int position) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switch (getAdapterPosition()){
                        case 0:
                            intent =  new Intent(context1, Activity_Hijaiyah_Fathah.class);
                            context1.startActivity(intent);
                            break;

                        case 1:
                            intent =  new Intent(context1, Activity_Hijaiyah_Kasrah.class);
                            context1.startActivity(intent);
                            break;

                        case 2:
                            intent =  new Intent(context1, Activity_Hijaiyah_Dammah.class);
                            context1.startActivity(intent);
