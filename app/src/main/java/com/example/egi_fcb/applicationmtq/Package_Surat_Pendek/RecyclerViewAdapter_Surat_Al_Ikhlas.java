...
public class RecyclerViewAdapter_Surat_Al_Ikhlas extends RecyclerView.Adapter<RecyclerViewAdapter_Surat_Al_Ikhlas.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Surat_Al_Ikhlas.User> values;
    Context context1;

    public RecyclerViewAdapter_Surat_Al_Ikhlas(Context context, List<Activity_Surat_Al_Ikhlas.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Surat_Al_Ikhlas.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_ayat, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Surat_Al_Ikhlas.RecyclerViewHolder holder, final int position) {
