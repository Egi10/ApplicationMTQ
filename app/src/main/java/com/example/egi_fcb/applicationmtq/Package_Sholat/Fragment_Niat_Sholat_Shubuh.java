...
public class Fragment_Niat_Sholat_Shubuh extends Fragment {

    ImageView imageView;
    TextView judul, arab, arti, ket;

    public Fragment_Niat_Sholat_Shubuh() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        judul.setText("Niat Sholat Shubuh");
        Typeface tf = Farsi.GetFarsiFont(rootView.getContext());
        arab.setTypeface(tf);
        arab.setText("اُصَلِّيْ فَرْضَ الصُّبْحِ رَكْعَتَيْنِ مُسْتَقْبِلَ اْلقِبْلَةِ اَدَاءً لِلَّهِ تَعَالَى" );

        arti.setText("Aku niat melakukan shalat fardu subuh 2 rakaat menghadap kiblat karena Allah ta'ala");
