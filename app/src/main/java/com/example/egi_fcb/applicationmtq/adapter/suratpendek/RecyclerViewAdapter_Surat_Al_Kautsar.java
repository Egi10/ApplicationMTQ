...
public class RecyclerViewAdapter_Surat_Al_Kautsar extends RecyclerView.Adapter<RecyclerViewAdapter_Surat_Al_Kautsar.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Surat_Al_Kautsar.User> values;
    Context context1;

    public RecyclerViewAdapter_Surat_Al_Kautsar(Context context, List<Activity_Surat_Al_Kautsar.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Surat_Al_Kautsar.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_ayat, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Surat_Al_Kautsar.RecyclerViewHolder holder, final int position) {
