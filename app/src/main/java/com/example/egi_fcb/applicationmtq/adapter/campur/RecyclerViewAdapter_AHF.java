...
public class RecyclerViewAdapter_AHF extends RecyclerView.Adapter<RecyclerViewAdapter_AHF.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Hijaiyah_Fathah.User> values;
    Context context1;

    public RecyclerViewAdapter_AHF(Context context, List<Activity_Hijaiyah_Fathah.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_AHF.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_AHF.RecyclerViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Intent intent = new Intent(v.getContext(), Activity_Hijaiyah_Fathah_Jelas.class);
