...
public class Fragment_Niat_Sholat_Dzuhur extends Fragment {

    ImageView imageView;
    TextView judul, arab, arti, ket;

    public Fragment_Niat_Sholat_Dzuhur() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        judul.setText("Niat Sholat Dzuhur");
        Typeface tf = Farsi.GetFarsiFont(rootView.getContext());
        arab.setTypeface(tf);
        arab.setText("اُاُصَلِّيْ فَرْضَ الظُّهْرِ اَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ اْلقِبْلَةِ اَدَاءً لِلَّهِ تَعَالَى");

        arti.setText("Aku niat melakukan shalat fardu dzuhur 4 rakaat menghadap kiblat karena Allah ta'ala");
