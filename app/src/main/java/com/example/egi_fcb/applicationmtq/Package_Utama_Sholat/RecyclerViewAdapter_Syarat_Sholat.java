...
public class RecyclerViewAdapter_Syarat_Sholat extends RecyclerView.Adapter<RecyclerViewAdapter_Syarat_Sholat.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Syarat_Sholat.User> values;
    Context context1;

    public RecyclerViewAdapter_Syarat_Sholat(Context context, List<Activity_Syarat_Sholat.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Syarat_Sholat.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_syarat_wudhu, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Syarat_Sholat.RecyclerViewHolder holder, final int position) {
