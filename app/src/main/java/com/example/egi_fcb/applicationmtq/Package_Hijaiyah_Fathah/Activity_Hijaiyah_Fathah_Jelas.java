...
public class Activity_Hijaiyah_Fathah_Jelas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Lihat Hijaiyah Fathah");
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        Intent myIntent = new Intent(getApplicationContext(), Activity_Hijaiyah_Fathah.class);
