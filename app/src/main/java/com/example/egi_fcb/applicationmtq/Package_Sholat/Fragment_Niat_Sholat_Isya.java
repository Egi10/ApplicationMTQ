...
public class Fragment_Niat_Sholat_Isya extends Fragment {

    ImageView imageView;
    TextView judul, arab, arti, ket;

    public Fragment_Niat_Sholat_Isya() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        judul.setText("Niat Sholat Isya");
        Typeface tf = Farsi.GetFarsiFont(rootView.getContext());
        arab.setTypeface(tf);
        arab.setText("اُصَلِّيْ فَرْضَ الْعِشَاءِ اَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ اْلقِبْلَةِ اَدَاءً لِلَّهِ تَعَالَى");

        arti.setText("Aku berniat melakukan shalat fardu Isya 4 rakaat, sambil menghadap qiblat, karena Allah ta'ala");
