...
public class RecyclerViewAdapter_Tanwin_Kasrohtain extends RecyclerView.Adapter<RecyclerViewAdapter_Tanwin_Kasrohtain.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Tanwin_Kasrohtain.User> values;
    Context context1;

    public RecyclerViewAdapter_Tanwin_Kasrohtain(Context context, List<Activity_Tanwin_Kasrohtain.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Tanwin_Kasrohtain.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Tanwin_Kasrohtain.RecyclerViewHolder holder, final int position) {
