...
import com.example.egi_fcb.applicationmtq.adapter.campur.MyCustomLayoutManager;
import com.example.egi_fcb.applicationmtq.adapter.campur.RecyclerViewAdapter_AAH;
import com.example.egi_fcb.applicationmtq.R;

import java.util.ArrayList;
import java.util.List;

public class Activity_Asmaul_Husna extends AppCompatActivity {
    RecyclerView recyclerView;
    MediaPlayer mp;

    RecyclerViewAdapter_AAH recyclerViewAdapter;
    RecyclerView.LayoutManager recyclerViewLayoutManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu_utama_doa);
        ...
        mp = MediaPlayer.create(Activity_Asmaul_Husna.this, R.raw.ilma_plojovic_asmaul_husna);
        ...
        //collapsingToolbar.setTitle("Asma'ul Husna");

        recyclerView = (RecyclerView)findViewById(R.id.recycler_view);
        recyclerView.setHasFixedSize(true);

        //Change 2 to your choice because here 2 is the number of Grid layout Columns in each row.
        recyclerViewLayoutManager = new MyCustomLayoutManager(getApplicationContext());
        recyclerView.setLayoutManager(recyclerViewLayoutManager);
        recyclerViewAdapter = new RecyclerViewAdapter_AAH(Activity_Asmaul_Husna.this,getUserInformation());
        recyclerView.setAdapter(recyclerViewAdapter);
    }

    private List<Activity_Asmaul_Husna.User> getUserInformation() {
    ...
    public boolean onOptionsItemSelected(final MenuItem item){
        ...
        switch (item.getItemId()) {
            case R.id.suara:
                ...
                Toast.makeText(Activity_Asmaul_Husna.this, "Suara : Ilma (علم) Plojovic - Esma ul Husna (99 Names of Allah) أسماء الله - عیلم پلۆجۆڤیك"+"\n"+
                "Link : https://www.youtube.com/watch?v=lm9S_K17-XU", Toast.LENGTH_SHORT).show();
            ...
            default:
                mp.stop();
                Activity_Asmaul_Husna.this.finish();
