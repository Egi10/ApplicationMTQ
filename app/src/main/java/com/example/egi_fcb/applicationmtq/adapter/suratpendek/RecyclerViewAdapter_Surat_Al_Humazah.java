...
public class RecyclerViewAdapter_Surat_Al_Humazah extends RecyclerView.Adapter<RecyclerViewAdapter_Surat_Al_Humazah.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Surat_Al_Humazah.User> values;
    Context context1;

    public RecyclerViewAdapter_Surat_Al_Humazah(Context context, List<Activity_Surat_Al_Humazah.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Surat_Al_Humazah.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_ayat, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Surat_Al_Humazah.RecyclerViewHolder holder, final int position) {
