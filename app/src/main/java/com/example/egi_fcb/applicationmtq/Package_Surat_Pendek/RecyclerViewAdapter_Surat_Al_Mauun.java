...
public class RecyclerViewAdapter_Surat_Al_Mauun extends RecyclerView.Adapter<RecyclerViewAdapter_Surat_Al_Mauun.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Surat_Al_Mauun.User> values;
    Context context1;

    public RecyclerViewAdapter_Surat_Al_Mauun(Context context, List<Activity_Surat_Al_Mauun.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Surat_Al_Mauun.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_ayat, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Surat_Al_Mauun.RecyclerViewHolder holder, final int position) {
