...
public class RecyclerViewAdapter_Surat_Al_Falak extends RecyclerView.Adapter<RecyclerViewAdapter_Surat_Al_Falak.RecyclerViewHolder>{
    private ClickListener clicklistener = null;
    List<Activity_Surat_Al_Falak.User> values;
    Context context1;

    public RecyclerViewAdapter_Surat_Al_Falak(Context context, List<Activity_Surat_Al_Falak.User> userInformation) {
        context1 = context;
        this.values = userInformation;
    }

    @Override
    public RecyclerViewAdapter_Surat_Al_Falak.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.costum_activity_ayat, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final RecyclerViewAdapter_Surat_Al_Falak.RecyclerViewHolder holder, final int position) {
